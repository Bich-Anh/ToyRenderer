...
class camera {
    ...
    private:
        ...
        void initialize() {
            ...
            w = unit_vector(lookfrom - lookat); // Direction the camera is looking at (right hand coordinate system)
            u = unit_vector(cross(vup, w));     // Making a vector orthogonal to the plane made by w and vup
    ...
    public:
        ...
        void render(const hittable_list& world) {
            ...
            now = std::chrono::steady_clock::now();
            std::clog << "\rDone in " << format_elapsed_time(start_time, now) << ".                                                           \n";
